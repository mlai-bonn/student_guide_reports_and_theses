...
We can see that the proposed outline is indeed very similar to how a report or thesis is structured but the formal presentation differs greatly. While there is no right or wrong for how your slides should look, there are of course some best practices we recommend:
% Some very general best practices for the slides:

% Slides
\begin{itemize}
    \item do not put entire sentences on the slides, note down keywords
    \item take your time to explain your math
    \item use illustrative images to underline your messages
    \item graphs: explain units, axes, methodology and take away messages
    \item use pseudocode to illustrate algorithms
    % up for debate:
...
Depending on the target audience, context of the talk and time constraints, one may have to make trade-offs between all of those points. A very simple, but helpful guiding question to help with this is: What is the most important thing that you want the audience to remember from your talk?
